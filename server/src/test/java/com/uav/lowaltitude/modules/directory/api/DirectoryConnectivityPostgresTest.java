...
class DirectoryConnectivityPostgresTest extends DirectoryApiTest {
    private static final String SCHEMA="directory_notification_"+UUID.randomUUID().toString().replace("-","");
