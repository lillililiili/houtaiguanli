...
<template>
  <div class="page-stack rules-page">
    <PageHeader title="规则管理" description="这三类规则只用于前台告警到处罚。一类中的规则全部满足后，系统自动完成核实、反制或通知处罚，不靠规则开关控制人工按钮。" />
