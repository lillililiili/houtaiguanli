...
public class MqttRepository {
    ...
    public String register(Registration p, long now) {
        ...
        jdbc.update("""
                ...
                p.model(),p.vendor(),p.sourceMode(),simulated,now,now,p.longitude(),p.latitude(),
                p.longitude()==null?null:"WGS-84",p.altitudeM(),p.ownerOrgId(),p.districtId());
        jdbc.update("""
